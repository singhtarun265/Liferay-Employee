...
package org.javasavvy.leave.service.persistence;
...
public class LeaveUtil {
	...
	public static Leave findByUuid_First(
		...
		throws org.javasavvy.leave.exception.NoSuchLeaveException {
	 ...
	 * @return the ordered range of matching leaves
	 */
	public static List<Leave> findByuserId(
	 ...
	 * @throws NoSuchLeaveException if a matching leave could not be found
	 */
	public static Leave findByuserId_First(
	 ...
	 * @return the first matching leave, or <code>null</code> if a matching leave could not be found
	 */
	public static Leave fetchByuserId_First(
		long userId, OrderByComparator<Leave> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveException if a matching leave could not be found
	 */
	public static Leave findByuserId_Last(
			long userId, OrderByComparator<Leave> orderByComparator)
		throws org.javasavvy.leave.exception.NoSuchLeaveException {
	 ...
	 * @return the last matching leave, or <code>null</code> if a matching leave could not be found
	 */
	public static Leave fetchByuserId_Last(
		long userId, OrderByComparator<Leave> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveException if a leave with the primary key could not be found
	 */
	public static Leave[] findByuserId_PrevAndNext(
			long leaveId, long userId,
			OrderByComparator<Leave> orderByComparator)
		throws org.javasavvy.leave.exception.NoSuchLeaveException {

		return getPersistence().findByuserId_PrevAndNext(
			leaveId, userId, orderByComparator);
	}
	...
	private static ServiceTracker<LeavePersistence, LeavePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LeavePersistence.class);

		ServiceTracker<LeavePersistence, LeavePersistence> serviceTracker =
			new ServiceTracker<LeavePersistence, LeavePersistence>(
				bundle.getBundleContext(), LeavePersistence.class, null);
